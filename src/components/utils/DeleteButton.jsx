...
export default function DeleteButton({ accountId, onDeleted }) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Cette action va clôturer ce compte et transférer son solde vers
              votre compte principal, si disponible. Cette opération est irréversible.
            </p>
